{{-- Llamamos al componente app-layout que se encuentra en la ruta App/View/Components/AppLayout  
    y dentro de esas etiquetas va a ir todo lo que queramos que se muestre--}}
<x-app-layout>
    Hola mundo
</x-app-layout>
